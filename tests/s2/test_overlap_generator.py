...
def generate_geometry():
    ...
    sparql_results = [
        ...
        {
            'feature_iri': rdflib.term.URIRef('http://stko-kwg.geog.ucsb.edu/lod/resource/geometry.polygon.s2.level1.10664523917613334528'),
            'wkt': rdflib.term.Literal(
...
class OverlapGeneratorTests(unittest.TestCase):
    ...
    def setUp(self, map_mock, writer_mock, result_sets_mock):
        ...
        batch_size = 10
        self.overlap_generator = S2OverlapGenerator(geometry_path, rdf_format, tolerance, min_level, max_level, output_folder, batch_size)
    ...
    def test_write_to_rdf_small_batch(self,):
        """
